...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void arcadeDrive(double throttle, double turn) {
    ...
    int motorPowerLeft = (int) (-turn + throttle);
    int motorPowerRight = (int) (-turn - throttle);

    leftMotor1.set(ControlMode.PercentOutput, motorPowerLeft); 
    rightMotor1.set(ControlMode.PercentOutput, motorPowerRight);
  }
}
